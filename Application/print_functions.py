...
print(First_script.One_Func()) # Can call any function in First_script
print(Two_Func()) # Calling Two_Func directly from Second_script
...
print(Third_script.Three_Func()) # Just note all of "Third_script.py" has been imported
print(Four_Func()) # Only Four_Func is imported due to __init__.py file in "package" folder
...
print(Fifth_script.Five_Func()) # All of Fifth_script has been imported
print(Six_Func()) # Only Six_Func imported through __init__.py file in "subpackages" folder  